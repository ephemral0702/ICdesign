...
export interface InitOutput {
  ...
  readonly closure102_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbd788c4c38fd0ffc_multivalue_shim: (a: number, b: number) => [number, number];
  readonly __externref_table_dealloc: (a: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h63da089eb31c0f5b: (a: number, b: number) => void;
  readonly closure181_externref_shim: (a: number, b: number, c: any, d: any) => void;
